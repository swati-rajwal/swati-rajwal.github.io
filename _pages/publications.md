...
<table style="width:100%; border-collapse: collapse; border: none;">
  ...
  <tr style="border: none; background-color: #FFFFFF;">
    ...
    <td style="width: 30%; padding: 20px 0; border: none; text-align: center;">
      <img src="/images/2026_pcd.png" alt="Publication Thumbnail" style="max-width: 100%; height: auto;">
    </td>
    <!-- Publication Info Column -->
  <td style="width: 70%; border: none;">
      <h3 style="margin: 0;">Diagnostic Reasoning with Large Language Models for a Rare Disease: Case Study of Primary Ciliary Dyskinesia</h3>
      <p style="margin: 5px 0; color: #555;"><b>Swati Rajwal</b>, Mary Ellen Fain, Lokesh Guglani, Abeed Sarker</p>
      ...
      <div class="publication-buttons" style="margin-top: 10px;">
        ...
        <a href="https://doi.org/10.1093/ajrccm/aamag162.1273" target="_blank" class="btn" style="text-decoration: none; background-color: #007bff; color: white; padding: 5px 10px; border-radius: 5px; display: inline-block; margin-right: 5px;">American J. of Respiratory & Critical Care Med.</a>
        <a href="https://doi.org/10.63317/3zvnibnkbvsc" target="_blank" class="btn" style="text-decoration: none; background-color: #007bff; color: white; padding: 5px 10px; border-radius: 5px; display: inline-block; margin-right: 5px;">LREC</a>
      </div>
    </td>
    </tr>
