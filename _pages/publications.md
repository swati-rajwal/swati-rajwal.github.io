...
<div class="publication-list">
  ...
  <div class="publication-item" style="display: flex; margin-bottom: 20px;">
    <!-- Publication Image -->
    <div class="publication-thumbnail" style="flex: 0 0 200px; /* Fixed size for image */ margin-right: 20px;">
      <img src="/images/bc_proj.png" alt="Publication Thumbnail" style="width: 200px; height: auto;">
    </div>
    <div class="publication-info" style="flex: 1;">
      ...
      <div class="publication-buttons" style="margin-top: 10px;">
        <a href="https://github.com/swati-rajwal/BreastCancer_tweets_project" class="btn" style="text-decoration: none; background-color: #007bff; color: white; padding: 5px 10px; border-radius: 5px; display: inline-block; margin-right: 5px;">PAPER</a>
        <a href="https://github.com/swati-rajwal/BreastCancer_tweets_project" class="btn" style="text-decoration: none; background-color: #007bff; color: white; padding: 5px 10px; border-radius: 5px; display: inline-block; margin-right: 5px;">CODE</a>
      </div>
    </div>
  </div>
